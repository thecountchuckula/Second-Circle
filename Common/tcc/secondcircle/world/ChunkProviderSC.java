...
public class ChunkProviderSC implements IChunkProvider
{
    ...
    public ChunkProviderSC(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenLakes(Blocks.quartz_ore)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
