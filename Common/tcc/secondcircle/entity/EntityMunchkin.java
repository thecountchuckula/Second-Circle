...
public class EntityMunchkin extends EntityMob implements IRangedAttackMob
{
    ...
    {
        return Reference.SOUNDDIR + "munchkin.idle";
    }
    ...
    {
        return Reference.SOUNDDIR + "munchkin.hurt";
    }
    ...
    {
        return Reference.SOUNDDIR + "munchkin.death";
    }
    ...
    {
        EntityRock entityrock = new EntityRock(this.worldObj, this);
        double d0 = p_82196_1_.posX - this.posX;
        double d1 = p_82196_1_.posY + (double)p_82196_1_.getEyeHeight() - 1.100000023841858D - entityrock.posY;
        double d2 = p_82196_1_.posZ - this.posZ;
        float f1 = MathHelper.sqrt_double(d0 * d0 + d2 * d2) * 0.2F;
        entityrock.setThrowableHeading(d0, d1 + (double) f1, d2, 1.6F, 12.0F);
        this.playSound("random.bow", 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));
        this.worldObj.spawnEntityInWorld(entityrock);
    }
