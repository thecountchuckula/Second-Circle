...
public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
{
    ...
    public static boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
        byte b0 = 0;
        byte b1 = 0;
        if (par1World.getBlock(par2 - 1, par3, par4) == Blocks.brick_block || par1World.getBlock(par2 + 1, par3, par4) == Blocks.brick_block) {
            b0 = 1;
        }
        if (par1World.getBlock(par2, par3, par4 - 1) == Blocks.brick_block || par1World.getBlock(par2, par3, par4 + 1) == Blocks.brick_block) {
            b1 = 1;
        }
        if (b0 == b1) {
            return false;
            ...
            for (l = -1; l <= 2; ++l) {
                for (i1 = -1; i1 <= 3; ++i1) {
                    ...
                    if (l != -1 && l != 2 || i1 != -1 && i1 != 3) {
                        ...
                        if (flag) {
                            if (j1 != Blocks.brick_block) {
                                return false;
                            }
                        } else if (j1 != Blocks.air && j1 != Blocks.brick_block) {
                            return false;
                        }
                    }
                }
            ...
            for (l = 0; l < 2; ++l) {
                for (i1 = 0; i1 < 3; ++i1) {
                    par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, ModBlocks.portal, 0, 2);
                }
            }
            return true;
        }
    ...
    public static class Size
    {
        ...
        protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
        {
            ...
            block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
            return block == Blocks.brick_block ? i1 : 0;
        }
        ...
        protected int func_150858_a()
        {
            ...
            for (i = 0; i < this.field_150868_h; ++i)
            {
                ...
                if (this.field_150867_a.getBlock(j, k, l) != Blocks.brick_block)
                {
        ...
        {
            return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == ModBlocks.fire || p_150857_1_ == ModBlocks.portal;
        }
